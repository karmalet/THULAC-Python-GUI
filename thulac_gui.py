...
# 
# Graphic User Interface for THULAC POS tagger.
# All rights belong to its owner, THUNLP lab(https://github.com/thunlp/THULAC-Python).
...
root = Tk()
root.title('THULAC GUI - MJ Park (karmalet@duksung.ac.kr)')
